...
def TrainMLP(name_wind, name_day, cap, hidden_layers=[32], batch_size=64, num_epochs=500, weight_decay=1e-4, index_features=[0, 1, 2, 3, 4, 5]):
...
def Forecast1(file_weather, name_wind, longitude, latitude, a_input, b_input, a_output, b_output, today, hidden_layers=[32], name_features=['u100', 'v100', 'sp', 'tcw', 'a100', 't100'], l_hours=21, h_hours=51):
...
def Forecast4(file_weather, name_wind, longitude, latitude, a_input, b_input, a_output, b_output, today, hidden_layers=[32], name_features=['u100', 'v100', 'sp', 'tcw', 'a100', 't100'], l_hours=93, h_hours=122):
...
def main():
    ...
    longitude = 111.5
    latitude = 21.4
    a_input=[4700, 940, 6.3]
    b_input=[-20.94, 0, 0.5]
    a_output=410
    b_output=0.01
    cap = 399.9 / a_output + b_output
    hidden_layers=[128, 128, 128]
    TrainMLP('D', '1', cap, hidden_layers=hidden_layers, num_epochs=500, weight_decay=1e-3, index_features=[2, 4, 5])
    output1 = Forecast1(file_weather, 'D', longitude, latitude, a_input, b_input, a_output, b_output, pd.to_datetime(today_str), hidden_layers=hidden_layers, name_features=['sp', 'a100', 't100'])
    TrainMLP('D', '4', cap, hidden_layers=hidden_layers, num_epochs=100, weight_decay=1e-3, index_features=[2, 4, 5])
    output4 = Forecast4(file_weather, 'D', longitude, latitude, a_input, b_input, a_output, b_output, pd.to_datetime(today_str), hidden_layers=hidden_layers, name_features=['sp', 'a100', 't100'])
    ...
    hidden_layers=[128, 128, 128]
    TrainMLP('E', '1', cap, hidden_layers=hidden_layers, num_epochs=400, weight_decay=1e-3, index_features=[2, 4, 5])
    output1 = Forecast1(file_weather, 'E', longitude, latitude, a_input, b_input, a_output, b_output, pd.to_datetime(today_str), hidden_layers=hidden_layers, name_features=['sp', 'a100', 't100'])
    TrainMLP('E', '4', cap, hidden_layers=hidden_layers, num_epochs=100, weight_decay=1e-3, index_features=[2, 4, 5])
    output4 = Forecast4(file_weather, 'E', longitude, latitude, a_input, b_input, a_output, b_output, pd.to_datetime(today_str), hidden_layers=hidden_layers, name_features=['sp', 'a100', 't100'])
    ...
    hidden_layers=[128, 128, 128]
    TrainMLP('F', '1', cap, hidden_layers=hidden_layers, num_epochs=500, weight_decay=1e-3, index_features=[2, 4, 5])
    output1 = Forecast1(file_weather, 'F', longitude, latitude, a_input, b_input, a_output, b_output, pd.to_datetime(today_str), hidden_layers=hidden_layers, name_features=['sp', 'a100', 't100'])
    TrainMLP('F', '4', cap, hidden_layers=hidden_layers, num_epochs=100, weight_decay=1e-3, index_features=[2, 4, 5])
    output4 = Forecast4(file_weather, 'F', longitude, latitude, a_input, b_input, a_output, b_output, pd.to_datetime(today_str), hidden_layers=hidden_layers, name_features=['sp', 'a100', 't100'])
